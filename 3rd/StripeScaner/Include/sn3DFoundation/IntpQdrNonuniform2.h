...
#ifndef INTPQUADRATICNONUNIFORM2_H
#define INTPQUADRATICNONUNIFORM2_H
...
template <class Real>
class SN3D_FOUNDATION_ITEM IntpQdrNonuniform2
{
public:
...
private:
    class SN3D_FOUNDATION_ITEM TriangleData
    {
    public:
        Vector2<Real> Center;
    ...
    class SN3D_FOUNDATION_ITEM Jet
    {
    public:
        Real F, Fx, Fy;
    };
