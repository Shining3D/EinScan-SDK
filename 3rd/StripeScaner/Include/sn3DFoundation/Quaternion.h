...
public:
    ...
    // special values
    SN3D_FOUNDATION_ITEM static const Quaternion IDENTITY;
    SN3D_FOUNDATION_ITEM static const Quaternion ZERO;
...
private:
    ...
    SN3D_FOUNDATION_ITEM static int ms_iNext[3];

    // support for closest quaternions
    SN3D_FOUNDATION_ITEM static Real ms_fTolerance;
    SN3D_FOUNDATION_ITEM static Real ms_fRootTwo;
    SN3D_FOUNDATION_ITEM static Real ms_fRootHalf;
