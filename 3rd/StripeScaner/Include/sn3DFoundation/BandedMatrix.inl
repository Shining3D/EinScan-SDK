...
void BandedMatrix<Real>::Allocate ()
{
    ...
    m_afDBand = SN3D_NEW Real[m_iSize];
    memset(m_afDBand,0,m_iSize*sizeof(Real));

    if (m_iLBands > 0)
    {
        m_aafLBand = SN3D_NEW Real*[m_iLBands];
    }
    else
    {
        m_aafLBand = 0;
    ...
    if (m_iUBands > 0)
    {
        m_aafUBand = SN3D_NEW Real*[m_iUBands];
    }
    else
    {
        m_aafUBand = 0;
    ...
    for (i = 0; i < m_iLBands; i++)
    {
        m_aafLBand[i] = SN3D_NEW Real[m_iSize-1-i];
        memset(m_aafLBand[i],0,(m_iSize-1-i)*sizeof(Real));
    }

    for (i = 0; i < m_iUBands; i++)
    {
        m_aafUBand[i] = SN3D_NEW Real[m_iSize-1-i];
        memset(m_aafUBand[i],0,(m_iSize-1-i)*sizeof(Real));
    }
}
//----------------------------------------------------------------------------
...
void BandedMatrix<Real>::Deallocate ()
{
    ...
    if (m_aafLBand)
    {
        for (i = 0; i < m_iLBands; i++)
        {
            SN3D_DELETE[] m_aafLBand[i];
        }

        SN3D_DELETE[] m_aafLBand;
        m_aafLBand = 0;
    }
    ...
    if (m_aafUBand)
    {
        for (i = 0; i < m_iUBands; i++)
        {
            SN3D_DELETE[] m_aafUBand[i];
        }

        SN3D_DELETE[] m_aafUBand;
        m_aafUBand = 0;
    }
}
//----------------------------------------------------------------------------
