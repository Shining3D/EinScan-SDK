...
template <class Real>
class SN3D_FOUNDATION_ITEM Delaunay3 : public Delaunay<Real>
{
public:
...
private:
    ...
    class SN3D_FOUNDATION_ITEM Tetrahedron
    {
    public:
    ...
    class SN3D_FOUNDATION_ITEM Face : public ETManifoldMesh::Triangle
    {
    public:
