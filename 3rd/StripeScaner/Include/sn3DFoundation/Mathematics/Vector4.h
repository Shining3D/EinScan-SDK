...
public:
    ...
    // special vectors
    SN3D_FOUNDATION_ITEM static const Vector4 ZERO;
    SN3D_FOUNDATION_ITEM static const Vector4 UNIT_X;  // (1,0,0,0)
    SN3D_FOUNDATION_ITEM static const Vector4 UNIT_Y;  // (0,1,0,0)
    SN3D_FOUNDATION_ITEM static const Vector4 UNIT_Z;  // (0,0,1,0)
    SN3D_FOUNDATION_ITEM static const Vector4 UNIT_W;  // (0,0,0,1)
    SN3D_FOUNDATION_ITEM static const Vector4 ONE;     // (1,1,1,1)
