...
public:
    ...
    // special vectors
    SN3D_FOUNDATION_ITEM static const Vector2 ZERO;    // (0,0)
    SN3D_FOUNDATION_ITEM static const Vector2 UNIT_X;  // (1,0)
    SN3D_FOUNDATION_ITEM static const Vector2 UNIT_Y;  // (0,1)
    SN3D_FOUNDATION_ITEM static const Vector2 ONE;     // (1,1)
