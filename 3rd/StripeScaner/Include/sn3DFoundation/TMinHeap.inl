...
TMinHeap<Generator,Real>::TMinHeap (int iMaxQuantity, int iGrowBy)
{
    ...
    m_iGrowBy = iGrowBy;
    m_iQuantity = 0;
    m_akRecords = SN3D_NEW TMinHeapRecord<Generator,Real>[m_iMaxQuantity];
    m_apkRecords = SN3D_NEW TMinHeapRecord<Generator,Real>*[m_iMaxQuantity];
...
{
    SN3D_DELETE[] m_akRecords;
    SN3D_DELETE[] m_apkRecords;
}
//----------------------------------------------------------------------------
template <typename Generator, typename Real>
    ...
    Generator tGenerator, Real fValue)
{
    ...
    if (m_iQuantity == m_iMaxQuantity)
    {
        ...
        TMinHeapRecord<Generator,Real>* akNewRecords =
            SN3D_NEW TMinHeapRecord<Generator,Real>[iNewQuantity];
