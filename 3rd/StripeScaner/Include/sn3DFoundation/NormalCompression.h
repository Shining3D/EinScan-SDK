...
#ifndef NORMALCOMPRESSION_H
#define NORMALCOMPRESSION_H
...
SN3D_FOUNDATION_ITEM void CompressNormal (double dX, double dY, double dZ,
    unsigned short& rusIndex);

SN3D_FOUNDATION_ITEM void UncompressNormal (unsigned short usIndex,
