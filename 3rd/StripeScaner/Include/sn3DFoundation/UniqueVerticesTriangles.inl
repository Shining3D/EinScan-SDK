    ...
    TTuple<N,Real>*& rakOutVertex, int*& raiOutIndex)
{
    ...
    raiOutIndex = SN3D_NEW int[iIQuantity];
...
{
    SN3D_DELETE[] m_aiInToOutMapping;
}
//----------------------------------------------------------------------------
template <int N, class Real>
    ...
    TTuple<N,Real>*& rakOutVertex)
{
    ...
    m_aiInToOutMapping = SN3D_NEW int[m_iInVQuantity];
    ...
    rakOutVertex = SN3D_NEW TTuple<N,Real>[m_iOutVQuantity];
