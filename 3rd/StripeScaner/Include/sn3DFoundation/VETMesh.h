...
class SN3D_FOUNDATION_ITEM VETMesh
{
public:
    // A vertex is <v>.
    ...
    class SN3D_FOUNDATION_ITEM VertexAttribute
    {
    public:
        VertexAttribute ()
            :
    ...
    class SN3D_FOUNDATION_ITEM EdgeAttribute
    {
    public:
        EdgeAttribute ()
            :
    ...
    class SN3D_FOUNDATION_ITEM TriangleAttribute
    {
    public:
        TriangleAttribute ()
        {
