...
#ifndef INCREMENTALDELAUNAY2_H
#define INCREMENTALDELAUNAY2_H
...
class SN3D_FOUNDATION_ITEM IncrementalDelaunay2
{
public:
...
private:
    ...
    class SN3D_FOUNDATION_ITEM Edge : public VEManifoldMesh::Edge
    {
    public:
    ...
    class SN3D_FOUNDATION_ITEM RPVertex
    {
    public:
    ...
    class SN3D_FOUNDATION_ITEM Triangulate
    {
    public:
