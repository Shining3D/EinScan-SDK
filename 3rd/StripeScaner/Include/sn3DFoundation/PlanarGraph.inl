...
bool PlanarGraph<Point2>::InsertVertex (const Point2& rkPosition, int iIndex)
{
    ...
    Vertex* pkVertex = SN3D_NEW Vertex(rkPosition,iIndex);
...
{
    Primitive* pkPrimitive = SN3D_NEW Primitive(PT_ISOLATED_VERTEX);
    ...
    std::set<VertexPtr>& rkHeap, std::vector<Primitive*>& rkPrimitives)
{
    ...
    else
    {
        ...
        Primitive* pkPrimitive = SN3D_NEW Primitive(PT_FILAMENT);
    ...
    std::set<VertexPtr>& rkHeap, std::vector<Primitive*>& rkPrimitives)
{
    ...
    else if (pkVCurr == pkV0)
    {
        ...
        Primitive* pkPrimitive = SN3D_NEW Primitive(PT_MINIMAL_CYCLE);
