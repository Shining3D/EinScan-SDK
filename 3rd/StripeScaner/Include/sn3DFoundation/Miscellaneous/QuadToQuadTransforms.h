...
#ifndef QUADTOQUADTRANSFORMS_H
#define QUADTOQUADTRANSFORMS_H
...
template <class Real>
class SN3D_FOUNDATION_ITEM HmQuadToSqr
{
public:
...
template <class Real>
class SN3D_FOUNDATION_ITEM HmSqrToQuad
{
public:
...
template <class Real>
class SN3D_FOUNDATION_ITEM BiQuadToSqr
{
public:
...
template <class Real>
class SN3D_FOUNDATION_ITEM BiSqrToQuad
{
public:
