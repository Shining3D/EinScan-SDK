...
#ifndef RANDOMHYPERSPHERE_H
#define RANDOMHYPERSPHERE_H
...
SN3D_FOUNDATION_ITEM void RandomPointOnHypersphere (int iDimension,
    double* adPoint);
...
SN3D_FOUNDATION_ITEM void Histogram (int iDimension, double dAngle,
...
//    int i;
//
//    double** aadPoint = SN3D_NEW double*[iQuantity];
//    aadPoint[0] = SN3D_NEW double[iQuantity*iDimension];
...
//
//    int* aiHistogram = SN3D_NEW int[iQuantity];
//    double dAngle = 0.5;
...
//
//    SN3D_DELETE[] aiHistogram;
//    SN3D_DELETE[] aadPoint[0];
//    SN3D_DELETE[] aadPoint;
//}
}
