...
{
    raatArray = SN3D_NEW T*[iRows];
    raatArray[0] = SN3D_NEW T[iRows*iCols];
...
void Deallocate (T**& raatArray)
{
    if (raatArray)
    {
        SN3D_DELETE[] raatArray[0];
        SN3D_DELETE[] raatArray;
        raatArray = 0;
    }
}
//----------------------------------------------------------------------------
...
{
    raaatArray = SN3D_NEW T**[iSlices];
    raaatArray[0] = SN3D_NEW T*[iSlices*iRows];
    raaatArray[0][0] = SN3D_NEW T[iSlices*iRows*iCols];
...
void Deallocate (T***& raaatArray)
{
    if (raaatArray)
    {
        SN3D_DELETE[] raaatArray[0][0];
        SN3D_DELETE[] raaatArray[0];
        SN3D_DELETE[] raaatArray;
        raaatArray = 0;
    }
}
//----------------------------------------------------------------------------
