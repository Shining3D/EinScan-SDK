...
#if _MSC_VER < 1300
#define SN3D_USING_VC6
#elif _MSC_VER < 1310
#define SN3D_USING_VC70
#elif _MSC_VER < 1400
#define SN3D_USING_VC71
#else
#define SN3D_USING_VC80
#endif

#if defined(SN3D_USING_VC6)
...
// The use of SN3D_FOUNDATION_ITEM to export an entire class generates warnings
// when member data and functions involving templates or inlines occur.  To
// avoid the warning, SN3D_FOUNDATION_ITEM can be applied only to those items
...
#define SN3D_BIG_ENDIAN
#else
#define SN3D_LITTLE_ENDIAN
#endif
