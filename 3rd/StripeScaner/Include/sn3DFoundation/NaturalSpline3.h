...
#ifndef NATURALSPLINE3_H
#define NATURALSPLINE3_H
...
template <class Real>
class SN3D_FOUNDATION_ITEM NaturalSpline3 : public MultipleCurve3<Real>
{
public:
    enum BoundaryType
    {
...
protected:
    ...
    class SN3D_FOUNDATION_ITEM ThisPlusKey
    {
    public:
