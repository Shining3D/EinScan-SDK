...
#ifndef INTRUTILITY3_H
#define INTRUTILITY3_H
...
//----------------------------------------------------------------------------
template <class Real>
class SN3D_FOUNDATION_ITEM IntrConfiguration
{
public:
...
//----------------------------------------------------------------------------
template <class Real>
class SN3D_FOUNDATION_ITEM IntrAxis
{
public:
...
//----------------------------------------------------------------------------
template <class Real>
class SN3D_FOUNDATION_ITEM FindContactSet
{
public:
